!(function (e, t) {
    ...
    // Convert to float (e.g., "12.00" → 12.00), then to pence (× 100), then round
    var shippingInPence = Math.round(parseFloat(cleanPrice) * 100);
    console.log('4. Shipping converted to int (pence):', shippingInPence);
    
    var newTotal = originalCartTotal + shippingInPence;
    console.log('5. Calculation:', originalCartTotal, '+', shippingInPence, '=', newTotal);
